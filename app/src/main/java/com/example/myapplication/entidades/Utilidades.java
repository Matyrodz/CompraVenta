 ...
 */
    ...
    public static final String CREAR_TABLA_PRODUCTO = "CREATE TABLE "+ TABLA_PRODUCTO+" ("+CAMPO_ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+CAMPO_IDTIENDA+ " INTEGER NOT NULL, "+
            CAMPO_STOCK+ " INTEGER NOT NULL, "+CAMPO_PRECIO+ " REAL NOT NULL, "+CAMPO_NOMBRE+ " TEXT NOT NULL, "+CAMPO_DESCRIPCION+ " TEXT, "+CAMPO_CATEGORIA+" TEXT NOT NULL, "+
            CAMPO_LATITUD+" TEXT NOT NULL, "+CAMPO_LONGITUD+" TEXT NOT NULL, "+CAMPO_IMAGEN+ " TEXT)";
